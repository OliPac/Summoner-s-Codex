...
public class MapaController {
    ...
    // Método auxiliar para cargar una imagen en un ImageView
    private void loadImage(ImageView imageView, String path) {
        imageView.setImage(new Image(getClass().getResourceAsStream(path)));
    }

    // Método general para cargar una nueva escena
    ...
    private void showMonsterInfo(MouseEvent event) {
        loadScene(event, "/com/summonerscodex/views/MonstruosNeutrales.fxml");
    }

    @FXML
    private void showTorreInfo(MouseEvent event) {
        loadScene(event, "/com/summonerscodex/views/Estructuras.fxml");
    }

    @FXML
    private void showDrakeInfo(MouseEvent event) {
        loadScene(event, "/com/summonerscodex/views/Dragones.fxml");
    }

    @FXML
    private void showBaronInfo(MouseEvent event) {
        loadScene(event, "/com/summonerscodex/views/Baron.fxml");
    }
