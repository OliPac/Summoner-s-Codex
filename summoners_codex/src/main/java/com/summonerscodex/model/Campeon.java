...
public class Campeon {
    ...
    public String getImageUrl() throws Exception {
        ...
        return "https://ddragon.leagueoflegends.com/cdn/"+VERSION+"/img/champion/" + imageInfo.getFull();
    }
    ...
    public String getHabilidadQUrl() throws Exception {
        return getAbilityUrl(0);
    }

    public String getHabilidadWUrl() throws Exception {
        return getAbilityUrl(1);
    }

    public String getHabilidadEUrl() throws Exception {
        return getAbilityUrl(2);
    }

    public String getHabilidadRUrl() throws Exception {
        return getAbilityUrl(3);
    }

    private String getAbilityUrl(int index) throws Exception {
    	VERSION = RiotAPIService.obtenerUltimaVersion();
        if (abilities != null && index < abilities.size()) {
            return "https://ddragon.leagueoflegends.com/cdn/"+VERSION+"/img/spell/" + abilities.get(index).getImage().getFull();
        }
        return null;
    }
